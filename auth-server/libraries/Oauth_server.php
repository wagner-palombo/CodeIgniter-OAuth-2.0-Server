...
class Oauth_server {
	 ...
	 * @return string
	 */
	function generate_new_authorise_code($client_id = '', $user_id = '', $redirect_uri = '', $scopes = array())
	{
	...
	/**
	 * validate_authorise_code function.
	 * 
	 * @access public
	 * @param string $code
	 * @param string $client_id
	 ...
	 * @return bool|int
	 */
	function validate_authorise_code($code = "", $client_id = "", $redirect_uri = "")
	{
	 ...
	 * @return string
	 */
	function new_access_token($session_id = '')
	{
	 ...
	 * @return bool
	 */
	function has_access_token($user_id = '', $client_id = '')
	{
	 ...
	 * @return string
	 */
	function build_redirect($redirect_uri = "", $params = array())
	{
